...
class FileSystem:
	...
	def _describe_single_file(self, file_obj) -> str:
		"""Describe a single file with content preview logic"""
		DISPLAY_CHARS = 400
	...
	def describe(self) -> str:
		...
		for file_obj in self.files.values():
			...
			description += self._describe_single_file(file_obj)
